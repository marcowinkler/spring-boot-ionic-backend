...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Produto prod4 = new Produto(null, "Mesa de Escritorio", 380.00);
		...
		Produto prod8 = new Produto(null, "Racadeira", 800.00);
		...
		Cidade c3 = new Cidade(null, "Porto União", est2);
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "marcowinkler@yahoo.com", "5544444", TipoCliente.PESSOAFISICA);
